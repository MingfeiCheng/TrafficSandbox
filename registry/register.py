...
class Registry:
    ...
    def filter_actors(self, pattern):
        """
        Filter registered actors based on a pattern.
        ...
        """
        return {name: cls for name, cls in self._registry.items() if fnmatch.fnmatch(name, pattern)}
